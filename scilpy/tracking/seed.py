...
class DIPYSeedGenerator(object):
    """
    Wrapper for DIPY's random_seeds_from_mask method, adapted to
    work with a multithreaded scilpy.tracker.
    """
    def __init__(self, data, voxres, nb_seeds, seed_per_vox, random_seed):
        """
        Parameters
        ----------
        data: np.array
        ...
        if np.count_nonzero(data) == 0:
            raise ValueError("No positive voxels in the seeding mask!")
